...
class GPTDatasetV1(Dataset):
    ...
    def __init__(self, txt:str, tokenizer:Tokenizer, max_length:int, stride:int):
        ...
        for i in range(0, len(token_ids) - max_length, stride):
            ...
            target_chunk = token_ids[i + 1: i + 1 + max_length] # predict the next set of words
...
def create_dataloader_v1(dataset: Dataset,
                         batch_size: int,
                         shuffle=True,
                         drop_last=True,
                         num_workers=0
...
if __name__=="__main__":
    ...
    try:
        ...
        dataloader = create_dataloader_v1(dataset=dataset,
                                          batch_size=4,
                                          shuffle=True,
                                          drop_last=True,
                                          num_workers=0
