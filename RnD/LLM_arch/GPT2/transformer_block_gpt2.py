...
class TransformerBlockGPT2(torch.nn.Module):
    ...
    def __init__(self, **cfg):
        ...
        assert cfg["embed_dim"] % cfg["num_attention_heads"] == 0, ("Embedding dimension must be divisible by number of heads for "
                                                                    "this architecture"
                                                                   )

        self.multihead_attention_layer = MultiHeadAttention(embed_dim=cfg["embed_dim"],
